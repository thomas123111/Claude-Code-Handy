...
export const ITEM_CHAINS = {
  food: {
    ...
    icon: '🍖',
    levels: [
      { id: 'food_1', name: 'Krümel', emoji: '🌾', value: 1 },
      { id: 'food_2', name: 'Leckerli', emoji: '🦴', value: 3 },
      { id: 'food_3', name: 'Futternapf', emoji: '🥣', value: 8 },
      { id: 'food_4', name: 'Premium Futter', emoji: '🍖', value: 20 },
      { id: 'food_5', name: 'Festmahl', emoji: '🎂', value: 50 },
    ],
  },
  toy: {
    name: 'Spielzeug',
    icon: '🧸',
    levels: [
      { id: 'toy_1', name: 'Faden', emoji: '🧶', value: 1 },
      { id: 'toy_2', name: 'Ball', emoji: '⚽', value: 3 },
      { id: 'toy_3', name: 'Plüschtier', emoji: '🧸', value: 8 },
      { id: 'toy_4', name: 'Kratzbaum', emoji: '🌳', value: 20 },
      { id: 'toy_5', name: 'Spielparadies', emoji: '🎪', value: 50 },
    ],
  },
  bed: {
    name: 'Betten',
    icon: '🛏️',
    levels: [
      { id: 'bed_1', name: 'Decke', emoji: '🧣', value: 1 },
      { id: 'bed_2', name: 'Kissen', emoji: '💤', value: 3 },
      { id: 'bed_3', name: 'Körbchen', emoji: '🧺', value: 8 },
      { id: 'bed_4', name: 'Luxus-Bett', emoji: '🛏️', value: 20 },
      { id: 'bed_5', name: 'Himmelbett', emoji: '👑', value: 50 },
    ],
  },
  medicine: {
    name: 'Medizin',
    icon: '💊',
    levels: [
      { id: 'med_1', name: 'Pflaster', emoji: '🩹', value: 1 },
      { id: 'med_2', name: 'Salbe', emoji: '🧴', value: 3 },
      { id: 'med_3', name: 'Medizin', emoji: '💊', value: 8 },
      { id: 'med_4', name: 'Arzt-Set', emoji: '🩺', value: 20 },
      { id: 'med_5', name: 'Wunderheilung', emoji: '✨', value: 50 },
    ],
  },
  hygiene: {
    name: 'Pflege',
    icon: '🧼',
    levels: [
      { id: 'hyg_1', name: 'Wasser', emoji: '💧', value: 1 },
      { id: 'hyg_2', name: 'Seife', emoji: '🧼', value: 3 },
      { id: 'hyg_3', name: 'Bürste', emoji: '🪮', value: 8 },
      { id: 'hyg_4', name: 'Shampoo-Set', emoji: '🧴', value: 20 },
      { id: 'hyg_5', name: 'Wellness-Paket', emoji: '🛁', value: 50 },
    ],
  },
};
