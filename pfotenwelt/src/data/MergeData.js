...
export const ITEM_CHAINS = {
  ...
  bed: {
    ...
    levels: [
      ...
      { id: 'bed_2', name: 'Kissen', emoji: '💤', sprite: 'item_cushion', value: 3 },
      { id: 'bed_3', name: 'Körbchen', emoji: '🧺', sprite: 'item_bed', value: 8 },
      { id: 'bed_4', name: 'Luxus-Bett', emoji: '🛏️', sprite: 'item_bed', value: 20 },
      { id: 'bed_5', name: 'Himmelbett', emoji: '👑', sprite: 'item_bed', value: 50 },
    ],
  },
  medicine: {
    name: 'Medizin',
    ...
    levels: [
      ...
      { id: 'med_3', name: 'Medizin', emoji: '💊', sprite: 'item_medicine', value: 8 },
      { id: 'med_4', name: 'Arzt-Set', emoji: '🩺', sprite: 'item_medkit', value: 20 },
      { id: 'med_5', name: 'Wunderheilung', emoji: '✨', sprite: 'item_medkit', value: 50 },
    ],
  },
  hygiene: {
    name: 'Pflege',
    ...
    levels: [
      ...
      { id: 'hyg_2', name: 'Seife', emoji: '🧼', sprite: 'item_soap', value: 3 },
      { id: 'hyg_3', name: 'Bürste', emoji: '🪮', sprite: 'item_brush', value: 8 },
      { id: 'hyg_4', name: 'Shampoo-Set', emoji: '🧴', sprite: 'item_shampoo', value: 20 },
      { id: 'hyg_5', name: 'Wellness-Paket', emoji: '🛁', sprite: 'item_shampoo', value: 50 },
    ],
  },
};
